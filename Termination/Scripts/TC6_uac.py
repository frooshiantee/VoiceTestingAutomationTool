...
#print sys.argv[2]
try:
	i = os.system("/home/cfernando/sipp-3.3/sipp "+ sys.argv[1]+":5060 -i "+sys.argv[2]+ " -p 5062 -s +12012000051 -sf /home/Termination/Scenarios/TC6-uac.xml -m "+sys.argv[3]+ " >/home/Termination/Results/TC6.txt")    

#Filtering out the contents of .txt file and confirming if the test case is Pass/Fail

	f = open("/home/Termination/Results/TC6.txt","r")
	y = f.readlines()
