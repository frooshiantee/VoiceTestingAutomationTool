...
#print sys.argv[2]
try:
	i = os.system("usr/local/bin/sipp "+ sys.argv[1]+":5060 -i "+sys.argv[2]+ " -p 5062 -s +12012000052 -sf /etc/sipp/proxytesting/OC7-uac.xml -rtp_echo -m "+sys.argv[3]+ " >/etc/sipp/proxytesting/OC7.txt")    
